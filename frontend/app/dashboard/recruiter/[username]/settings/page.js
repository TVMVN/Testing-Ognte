          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2 text-emerald-700">
                ...
                <span className="font-medium">Recruiter Settings</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-slate-600 text-lg mt-1">
                Manage your recruiter account preferences and security
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="p-6 border-2 border-red-200 rounded-xl bg-gradient-to-br from-red-50 to-orange-50">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-bold text-red-800 text-lg mb-2">Delete Recruiter Account</h3>
                    <div className="space-y-2 text-sm text-red-700 mb-4">
                      ...
                      <ul className="list-disc list-inside ml-4 space-y-1 text-red-600">
                        ...
                        <li>Recruiter profile and settings</li>
