          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2 text-emerald-700">
                ...
                <span className="font-medium">Candidate Settings</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-slate-600 text-lg mt-1">
                Manage your candidate account preferences and security
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="p-6 border-2 border-red-200 rounded-xl bg-gradient-to-br from-red-50 to-orange-50">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-bold text-red-800 text-lg mb-2">Delete Candidate Account</h3>
                    <div className="space-y-2 text-sm text-red-700 mb-4">
                      ...
                      <ul className="list-disc list-inside ml-4 space-y-1 text-red-600">
                        <li>All records and data</li>
                        <li>Job applications and employer connections</li>
                        <li>Candidate profile and settings</li>
                    ...
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription className="space-y-4 text-slate-700">
                        <div className="p-4 bg-red-50 rounded-lg border border-red-200">
                          ...
                          <p className="text-sm">This will permanently delete your candidate account and all associated data. This action cannot be reversed.</p>
                        </div>
